      ...
      <aside className={cn(
        ...
        <div className="h-full flex flex-col relative">
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute -right-4 top-8 rounded-full shadow-sm bg-white dark:bg-slate-800 disabled hidden md:flex h-8 w-8 z-50 text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-200"
              ...
              <Link
                ...
                className={cn(
                  ...
                  location.pathname === item.path
                    ...
                    : "text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:bg-slate-950 dark:hover:bg-slate-800"
                )}
            ...
            {isDesktopCollapsed ? (
              <div className="flex flex-col items-center gap-4 mb-2">
                ...
                <div className="flex flex-col gap-1 items-center bg-slate-100 dark:bg-slate-800 p-1.5 rounded-full">
                  <button onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} className="p-1.5 rounded-full hover:bg-white dark:bg-slate-900 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400">
              ...
              <>
                <Link to="/profile" className="flex items-center gap-3 px-4 py-3 mb-2 rounded-xl hover:bg-slate-50 dark:bg-slate-950 dark:hover:bg-slate-800 transition-colors group">
                ...
                <div className="flex items-center justify-between px-2 mb-4 bg-slate-100 dark:bg-slate-800/50 p-1 rounded-xl">
                  <button onClick={() => setTheme('light')} className={cn("flex-1 py-1.5 rounded-lg flex justify-center text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-slate-100 dark:hover:text-slate-100 transition-colors", theme === 'light' && "bg-white dark:bg-slate-700 shadow-sm text-foreground")}>
                    <Sun size={16} />
                  </button>
                  <button onClick={() => setTheme('dark')} className={cn("flex-1 py-1.5 rounded-lg flex justify-center text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-slate-100 dark:hover:text-slate-100 transition-colors", theme === 'dark' && "bg-white dark:bg-slate-700 shadow-sm text-foreground")}>
                    <Moon size={16} />
                  </button>
                  <button onClick={() => setTheme('system')} className={cn("flex-1 py-1.5 rounded-lg flex justify-center text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-slate-100 dark:hover:text-slate-100 transition-colors", theme === 'system' && "bg-white dark:bg-slate-700 shadow-sm text-foreground")}>
                    <Monitor size={16} />
                  </button>
                </div>
